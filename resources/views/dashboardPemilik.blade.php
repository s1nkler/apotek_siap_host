...
<head>
    ...
    <title>Halaman Pemilik Apotek</title>
    ...
    <style>
        ...
        footer.main-footer {
            background: linear-gradient(90deg, rgb(16, 16, 18) 0%, rgb(15, 17, 16) 100%);
            color: #ccc;
            height: auto;
            width: auto;
        }
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('laporanReguler.index') }}" class="nav-link {{ request()->is('laporan-reguler') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-file-alt"></i>
                                <p>Laporan Reguler</p>
                            </a>
                            <a href="{{ route('indexLaporanObat') }}" class="nav-link {{ request()->is('laporan-obat') ? 'active' : '' }}">
